...
write_file = args.output or args.tag and f'latency_lb_{args.tag}.json' or 'output'
...
b.attach_kprobe(event='load_balance', fn_name='trace_func_enter')
b.attach_kretprobe(event='load_balance', fn_name='trace_func_return')
